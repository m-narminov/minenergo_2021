...
<template>
    <div class="relative text-gray-600 search-bar mx-3 sm:flex hidden">
        <input @click="isSearchOpen = true" class="bg-purple-50 bg-gray-100 h-10 px-5 pr-10 rounded-full text-sm focus:outline-none" type="search" name="search" placeholder="Поиск+">
